...
> **Info**: For detailed usage examples of the API, see the [Functions Reference](/celline/api/functions) section for detailed explanations of individual functions.